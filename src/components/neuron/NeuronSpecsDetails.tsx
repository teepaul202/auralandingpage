...
interface NeuronSpecsDetailsProps {
  specifications: ProductSpecification[];
}

export default function NeuronSpecsDetails({ specifications }: NeuronSpecsDetailsProps) {
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <div className="lg:col-span-4 space-y-4">
          ...
          <p className="text-xs text-neutral-500 font-sans leading-relaxed max-w-sm">
            Meticulously engineered from custom silicon layers up. Review the raw technical specifications and boundaries that shape the high-performance capabilities.
          </p>
        </div>
                    ...
                    >
                      <div className="px-6 pb-6 border-t border-neutral-100 pt-4 space-y-4">
                        {cat.details.map((detail) => (
                          <div key={detail.label} className="grid grid-cols-1 md:grid-cols-12 gap-2 md:gap-6 py-2 border-b border-neutral-50 last:border-b-0 text-xs">
